                        ...
                        <td>
                            ...
                            <?php if(($terminee || $complet) && $acceptes > 0): ?>
                                <a href="evaluer_ouvrier.php?id=<?= $o['id_offre'] ?>">
                                    <button class="btn" style="padding: 5px 12px; font-size: 12px; margin-top: 5px; background: linear-gradient(135deg, #00c853, #009624); color: white;">Évaluer ouvriers</button>
                                </a>
                            <?php endif; ?>
                        </td>
                    </tr>
